...
public sealed partial class RuntimeChecks
{
    private void RunP2Completion()
    {
        ...
        Check(A.SessionReady && A.State.Talents.ContainsKey("FlightTime") && TerrariaProgression.Networking.ProgressionNetwork.ProtocolVersion==18,"current protocol imports completion catalog");
        Reset();
    }
}
