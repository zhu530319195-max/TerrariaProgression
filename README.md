...
- 多套天赋方案，各自分配全部已获点数，仅当前方案生效；支持新建、复制、改名、删除。
...
**版本0.15.1（待复验）**，目标tModLoader v2026.07.3.0 / Terraria 1.4.4.9 / .NET8。内部标识仍为`TerrariaProgression`；角色存档v4、联机协议18。

| 按键 | 功能 |
|---|---|
| P | 天赋面板 |
| Shift＋1～9、Shift＋0 | 切换第1～10套方案；可在本机模组配置改键 |
| 左Alt | 批量采集开／关 |
| G | 范围挖矿／矿脉连锁 |
| K | 额外挖矿保护开／关，默认关闭 |
...
PR #17全服经验共享已按用户授权合并。0.15.1修复方案文字输入并新增自定义切换组合键，等待实机复验；[本批操作步骤](docs/TALENT_LOADOUTS_TEST_GUIDE_zh-CN.md)。升级前请备份角色，新存档不能交给旧版读取。
...
Version0.15.1 fixes text input and adds configurable loadout chords (Shift+1..9 / Shift+0). Independent talent loadouts, each with your full earned point budget. Only the active allocation applies. Playtesting is pending; back up characters before migrating. PR #17 for optional full server-wide kill XP was merged with user authorization.
...
Built for **tModLoader v2026.07.3.0 / Terraria 1.4.4.9 / .NET8**. The internal mod name remains `TerrariaProgression`, retaining existing character data. Save version4, network protocol18.
