...
info = (f"TerrariaProgression P3-Agriculture 0.11.0\nCommit: {commit}\n"
...
with zipfile.ZipFile(output / "TerrariaProgression_P3Agriculture_0.11.0_Test.zip", "w", zipfile.ZIP_DEFLATED) as archive:
...
with zipfile.ZipFile(output / "TerrariaProgression_P3Agriculture_0.11.0_Source.zip", "w", zipfile.ZIP_DEFLATED) as archive:
