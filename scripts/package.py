...
info = (f"TerrariaProgression P2-MenuFishing 0.8.0\nCommit: {commit}\n"
...
with zipfile.ZipFile(output / "TerrariaProgression_P2MenuFishing_0.8.0_Test.zip", "w", zipfile.ZIP_DEFLATED) as archive:
...
with zipfile.ZipFile(output / "TerrariaProgression_P2MenuFishing_0.8.0_Source.zip", "w", zipfile.ZIP_DEFLATED) as archive:
