...
public static class NumericTalents
{
    public static readonly IReadOnlyList<TalentDefinition> All = Array.AsReadOnly(new[] {
        ...
        new TalentDefinition("AfflictionDamage", TalentCategory.Combat, 20, EffectUnit.Percent, true),
        ...
        new TalentDefinition("FishingPower", TalentCategory.Economy, 5, EffectUnit.Flat, true),
